...
<button
	class="shadow-sharp hover:shadow-sharp-hover mt-1 ml-1 flex h-30 w-full flex-col rounded-lg border-2 border-slate-900 bg-rose-100 p-3 text-left align-top shadow-slate-900 transition-all duration-200 hover:-translate-0.5 hover:bg-rose-200"
	onclick={() => {
